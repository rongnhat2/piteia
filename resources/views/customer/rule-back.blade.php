            ...
            <div class="content-area content-about col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="site-main">
                    <div class="about-wrapper">
                        <h3 class="custom_blog_title">交換について</h3>
                        <div class="page-main-content about-us-content">
                            <p>ー返品・交換は可能？</p> 
                            <br>
                            <p>商品到着後3日以内、未使用(未開封)・未通電の場合に限り返品・交換をお受け致します。(お客様ご都合による返品・交換の場合は返送料、返金時振込手数料はお客様のご負担になります。)</p>
                            ...
                            <p>初期不良や破損等の場合は別途「不良品等の取扱条件」をご確認頂き、「<a href="mailto:sbtc.jpshop@gmail.com" style="color: #0084ff;">私達に電子メールを送り</a>」 までご連絡ください。 ご連絡は 商品到着後3日以内にお願い致します。</p>
                        </div>
                    </div>
                </div>
            </div>
